...
// import location from "./data/location"; // TBD - StateId - I chose SPanish Fork as first location
// import price from "./data/price"; // I seeded the defaults we had before, will update once we meet about it and decide
...
async function main() {
    ...
    // await prisma.requiredPolicies.createMany({ data: requiredPolicy });
