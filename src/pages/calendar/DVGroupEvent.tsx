...
const DVGroupEvent: React.FunctionComponent<Event> = ({ calendarEventType, count, id, title, start, isBooked }) => {
    ...
    return (
        <div id={id} className={` text-slate-100 px-1 h-full ${isDisabled ? 'bg-slate-400' : 'bg-purple-600'}`}>
