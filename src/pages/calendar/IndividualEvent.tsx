...
const IndividualEvent: React.FunctionComponent<Event> = ({ calendarEventType, count, id, title, start, isBooked }) => {
    ...
    return (
        <div id={id} className={`text-slate-700 px-1 h-full ${isDisabled ? 'bg-slate-400' : 'bg-orange-400'}`}>
